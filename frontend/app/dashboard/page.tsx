        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <div className="grid sm:grid-cols-2 gap-4">
              ...
              {/* World History */}
              <button className="p-6 rounded-2xl bg-gradient-to-br from-amber-500/20 to-orange-500/20 border border-amber-500/30 text-left group hover:scale-[1.02] transition-all duration-300">
                <span className="text-3xl mb-4 block group-hover:scale-110 transition-transform">🌍</span>
              ...
              {/* Technology */}
              <button className="p-6 rounded-2xl bg-gradient-to-br from-indigo-500/20 to-purple-500/20 border border-indigo-500/30 text-left group hover:scale-[1.02] transition-all duration-300">
                <span className="text-3xl mb-4 block group-hover:scale-110 transition-transform">💻</span>
                <h3 className="text-xl font-bold mb-1">Technology</h3>
                <p className="text-sm text-gray-400">210 Quizzes</p>
              </button>

              {/* Arts & Literature */}
              <Link href="/dashboard/categories/arts-literature" className="group">
                <div className="p-6 h-full rounded-2xl bg-gradient-to-br from-rose-500/20 to-pink-500/20 border border-rose-500/30 text-left hover:scale-[1.02] transition-all duration-300">
                  <span className="text-3xl mb-4 block group-hover:scale-110 transition-transform">🎨</span>
                  <h3 className="text-xl font-bold mb-1">Arts & Literature</h3>
                  <p className="text-sm text-gray-400">10 Questions (10th Grade)</p>
                </div>
              </Link>
            </div>
            </section>
